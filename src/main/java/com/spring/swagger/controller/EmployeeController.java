...
import com.spring.swagger.exception.MyFileNotFoundException;
import com.spring.swagger.service.EmployeeService;
...
public class EmployeeController {
    ...
    public @ResponseBody ResponseEntity<?> createEmployee(@Valid Employee employee,
        ...
        try {
            ...
            boolean status = employeeSer.saveEmployee(employee);
            if (status) {
    ...
    public ModelAndView showAllEmployees() {
        ...
        List<Employee> employeeList = employeeSer.getAllEmployees();
    ...
    public ModelAndView removeFileHandler(@PathVariable("id") Long id, @PathVariable("deletedFileName") String deletedFileName) {
        ...
        try {
            ...
            if(file.exists()) {
                ...
                boolean status = employeeSer.deleteFile(id, deletedFileName);
